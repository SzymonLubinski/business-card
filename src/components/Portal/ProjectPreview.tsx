...
import {ProjectType} from "../../utils/MyTypes";
...
export default function ProjectPreview(props: ProjectPreviewProps){
    ...
    return (
        <Portal onClose={() => dispatch(setPortal({
            active: false,
            item: staticData[0],
        }))}>
            <div className={styles.container}>
                <div className={styles.close} onClick={() => dispatch(setPortal({
                    active: false,
                    item: staticData[0],
                }))}>
                ...
                <img src={props.project.img} alt={`preview: ${props.project.name}`}/>
